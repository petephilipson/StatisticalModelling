...
```{r, fig.show = 'hold', fig.cap = "Scatterplot of weight against (average) food consumption (left) and exercise (right) for the body weight study", echo=FALSE, fig.align='center', out.width='48%'}
